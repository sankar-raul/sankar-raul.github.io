...
1. **Calculator**
   - Dive into the [calculator project](calculator/) and explore some cool computations.

2. **Clock**
   - Discover the [clock project](clock/) and see how I've implemented timekeeping.
